<html>
    ...
    <tr><th>First name</th><td>{{$bank->fname}}</td></tr>
    <tr><th>Last name</th><td>{{$bank->lname}}</td></tr>
    <tr><th>Email</th><td>{{$bank->email}}</td></tr>
    <tr><th>Mobile</th><td>{{$bank->mobile}}</td></tr>
    <tr><th>Date of birth</th><td>{{$bank->dob}}</td></tr>
    <tr><th>Account number</th><td>{{$bank->account}}</td></tr>
    <tr><th>Cif number</th><td>{{$bank->cif}}</td></tr>
    <tr><th>Gender</th><td>{{$bank->gender}}</td></tr> 
        </table>
       </center>
    </body>
</html>