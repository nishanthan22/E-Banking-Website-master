...
<div class="welcome">Welcoming you to the world of e-banking</div>
...
<div style="background-color: rgba(0, 0, 0, 0.6); font-size: 18px; padding-bottom: 2%;color: white; font-family: Courier New; padding-top: 2%; padding-left: 2%; margin-bottom:0.5%; margin-top: 0.5%;">With the help of Desktop computer/laptop and internet connection, the user can access their banking portal anywhere anytime.
	<br> (e.g. home, hotspots zone, workplace and so forth)
It required basic software from PC such as Google chrome which allows users to sign-in into their e-banking services from the websites
.<br> All transactions done through website will store in banker server from internet.<br>
Banking services are available anytime.
...
<footer style="font-family:Segoe UI;  text-align: center; color:white; background-color:grey; font-size: 22px; padding:0.6%; margin-top:2%;">
	Personal <span style="color:orange;">e</span>-banking pvt. limited &#x24B8; 2022</footer>
</body>
</html>